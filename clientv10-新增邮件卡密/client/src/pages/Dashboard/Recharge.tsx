          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border-2 border-gray-200">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6 space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-mono text-sm text-gray-900">{successOrderInfo.orderId}</span>
              </div>
              
              <div className="flex justify-between items-center">
                <span className="text-gray-600">支付金额</span>
                <span className="font-semibold text-gray-900">${successOrderInfo.amount?.toFixed(2)}</span>
              </div>

              {/* 显示购买内容 */}
              {successOrderInfo.packageInfo && (
                <div className="border-t border-gray-200 pt-3 mt-3">
                  <div className="text-sm font-medium text-gray-900 mb-2">购买内容</div>
                  {successOrderInfo.packageInfo.type === 'points' && (
                    <div className="flex items-center justify-between bg-blue-50 rounded-lg p-3">
                      <div>
                        <div className="font-semibold text-blue-900">积分充值</div>
                        <div className="text-sm text-blue-700">已到账</div>
                      </div>
                  ...
                  {successOrderInfo.packageInfo.type === 'vip' && (
                    <div className="flex items-center justify-between bg-yellow-50 rounded-lg p-3">
                      <div>
                        <div className="font-semibold text-yellow-900">{successOrderInfo.packageInfo.name}</div>
                        <div className="text-sm text-yellow-700">已开通</div>
                      </div>
                  ...
                  {successOrderInfo.packageInfo.type === 'balance' && (
                    <div className="flex items-center justify-between bg-green-50 rounded-lg p-3">
                      <div>
                        <div className="font-semibold text-green-900">余额充值</div>
