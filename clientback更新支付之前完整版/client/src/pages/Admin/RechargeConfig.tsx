                                ...
                                {config.pointsPackages.map((pkg, index) => (
                                    <div key={pkg.id} className="border rounded-lg p-4 bg-blue-50">
                                        <div className="grid grid-cols-12 gap-3 items-center">
                                            ...
                                            <div className="col-span-3">
                                                <label className="block text-xs text-gray-600 mb-1">原价（元）</label>
                                                <input
                                                    type="number"
                                                    value={pkg.originalAmount || ''}
                                                    onChange={(e) => {
                                                        const packages = [...config.pointsPackages];
                                                        packages[index].originalAmount = parseInt(e.target.value) || undefined;
                                                        setConfig({ ...config, pointsPackages: packages });
                                                    }}
                                                    className="input-field text-sm"
                                                    placeholder="12"
                                            ...
                                            <div className="col-span-3">
                                                <label className="block text-xs text-gray-600 mb-1">现价（元）*</label>
                                                <input
                                                    type="number"
                                                    value={pkg.amount}
                                                    onChange={(e) => {
                                        ...
                                        {pkg.originalAmount && pkg.originalAmount > pkg.amount && (
                                            <div className="mt-2 text-xs text-green-600">
                                                💰 优惠 ¥{pkg.originalAmount - pkg.amount} 
                                    ...
                                    <div key={pkg.id} className="border rounded-lg p-3 mb-2 bg-blue-50">
                                        <div className="text-center">
                                            ...
                                            <div className="flex items-center justify-center space-x-2 mt-1">
                                                {pkg.originalAmount && pkg.originalAmount > pkg.amount && (
                                                    <span className="text-xs text-gray-500 line-through">¥{pkg.originalAmount}</span>
                                                )}
                                    ...
                                    <div key={pkg.id} className="border rounded-lg p-3 bg-gradient-to-br from-yellow-50 to-orange-50">
                                        <div className="text-center">
                                            ...
                                            <div className="flex items-center justify-center space-x-2">
                                                ...
                                                <span className="text-xl font-bold text-yellow-600">¥{pkg.amount}</span>
                                            </div>
                                        </div>
                                    </div>
                                ))}
