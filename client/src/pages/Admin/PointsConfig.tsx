          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => onUpdatePointsConfig({ ...pointsConfig, searchCost: parseFloat(e.target.value) || 0 })}
                className="input-field"
                min="0"
              />
              <p className="text-sm text-gray-500 mt-1">用户每次搜索需要消耗的积分数量（支持小数，如 5.5）</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onUpdatePointsConfig({ ...pointsConfig, exchangeRate: parseFloat(e.target.value) || 10 })}
                className="input-field"
                min="0.01"
              />
              <p className="text-sm text-gray-500 mt-1">1元余额可兑换的积分数量（例如：10.5表示1元=10.5积分）</p>
            </div>
          </div>
        </div>
                    ...
                    <input
                      ...
                      onChange={(e) => onUpdatePointsConfig({
                        ...
                        consecutiveBonus: {
                          ...
                          day7: parseFloat(e.target.value) || 0
                        }
                      })}
                      className="input-field"
                      min="0"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => onUpdatePointsConfig({
                        ...
                        consecutiveBonus: {
                          ...pointsConfig.consecutiveBonus,
                          day30: parseFloat(e.target.value) || 0
                        }
                      })}
                      className="input-field"
                      min="0"
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => onUpdatePointsConfig({ ...pointsConfig, referralReward: parseFloat(e.target.value) || 0 })}
                className="input-field"
                min="0"
              />
              <p className="text-sm text-gray-500 mt-1">邀请的用户注册并完成首次搜索后，邀请人获得的积分（支持小数）</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onUpdatePointsConfig({ ...pointsConfig, referredUserReward: parseFloat(e.target.value) || 0 })}
                className="input-field"
                min="0"
              />
              <p className="text-sm text-gray-500 mt-1">通过邀请链接注册的新用户获得的积分（支持小数）</p>
            </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => onUpdatePointsConfig({ ...pointsConfig, registerReward: parseFloat(e.target.value) || 0 })}
                className="input-field"
                min="0"
              />
              <p className="text-sm text-gray-500 mt-1">新用户注册时获得的初始积分（支持小数）</p>
            </div>
        ...
        <div className="card">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                type="number"
                value={pointsConfig.minWithdrawAmountBalance || 1}
                onChange={(e) => onUpdatePointsConfig({ ...pointsConfig, minWithdrawAmountBalance: parseFloat(e.target.value) })}
                className="input-field"
                min="0"
                step="0.01"
              />
              <p className="text-sm text-gray-500 mt-1">佣金提现到余额账户的最低金额（默认：$1.00）</p>
            </div>
            ...
            <div>
              ...
              <input
                type="number"
                value={pointsConfig.minWithdrawAmount || 10}
                onChange={(e) => onUpdatePointsConfig({ ...pointsConfig, minWithdrawAmount: parseFloat(e.target.value) })}
                className="input-field"
                min="0"
                step="0.01"
              />
              <p className="text-sm text-gray-500 mt-1">佣金提现到USDT钱包的最低金额（默认：$10.00）</p>
            </div>
