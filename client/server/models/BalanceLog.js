...
const balanceLogSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['recharge', 'recharge_card', 'consume', 'refund', 'commission', 'vip', 'search', 'exchange', 'withdraw', 'commission_to_balance', 'commission_withdraw', 'balance_income', 'register', 'referral_bonus', 'referral_reward', 'daily_claim'],
    required: true
  },
  currency: {
    type: String,
